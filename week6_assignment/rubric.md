...
Student: ______Dominique Ryan__________________
...
| Use in-line-block or floats in your CSS to achieve a two-column layout- Prevent a link execution with the ```event.preventDefault()``` function                                                                    |                                |                        |                          |
